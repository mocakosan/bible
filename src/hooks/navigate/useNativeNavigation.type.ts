/**
 * @url https://github.com/react-navigation/react-navigation/blob/main/packages/native-stack/src/types.tsx
 **/
...
export type paramList = { [key: string]: any };

export type hookRouteProp = RouteProp<paramList, string>;

export type hookNavigationProp = NativeStackNavigationProp<paramList, string> &
  DrawerNavigationProp<paramList, string>;
